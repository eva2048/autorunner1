                ...
                var dragging = function(e) {
                    ...
                    switch(dragDir) {
                        ...
                        case 'right':
                            ...
                            table.setAttribute('class','table-fullborder table-resize table-resize1');
                            $(".resizeTd").removeClass("resize-wrap");
                            if((offset*vx+scope.mWidth)>w){
                                element[0].style[prop] = scope.mWidth + 'px';
                                table.setAttribute('class','table-fullborder table-resize');
                                $(".resizeTd").addClass("resize-wrap");
